...
- Primera web HTML: Tim Berners-Lee
- <!-- .element: class="fragment" -->Páginas web simples y con diseño pobre.

------

- HTML permite especificar colores de fuentes, de fondos, de líneas...
- <!-- .element: class="fragment" -->Uso de imágenes y tablas para maquetar.
- <!-- .element: class="fragment" -->Uso de marcos para separar cabeceras

------

- Gifs animados, música de fondo MIDI, marquesinas, efectos JavaScript
- <!-- .element: class="fragment" -->Contadores de visitas
- <!-- .element: class="fragment" -->"En construcción"

------

- Inconvenientes de diseño
- <!-- .element: class="fragment" -->Diseño incrustado en contenido.
- <!-- .element: class="fragment" -->Mal uso de etiquetas HTML. Complejidad.
- <!-- .element: class="fragment" -->Marcos y navegadores
  - <!-- .element: class="fragment" -->URL no cambia.
  - <!-- .element: class="fragment" -->Buscadores no rastrean contenido.
...
- CSS y XHTML: `<div>` y `<span>`.
- <!-- .element: class="fragment" -->CSS y navegadores
  - <!-- .element: class="fragment" -->Internet Explorer VS Netscape Navigator
  - <!-- .element: class="fragment" -->Monopolio de Internet Explorer. Desprecio a los estándares.
  - <!-- .element: class="fragment" -->Mozilla Firefox y estándares W3C
  - <!-- .element: class="fragment" -->Consecuencia: CSS para cada navegador
- <!-- .element: class="fragment" -->Macromedia Flash
- <!-- .element: class="fragment" -->HTML5 y CSS3
...
- <!-- .element: class="fragment" -->Imágenes y Multimedia: tamaño y resolución, estilos, uso de vídeo y audio...
